...
public class ChangerDeer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (DeerUnity.CurrentActive == 1)
        {
            ...
            currentActiveCircle.GetComponent<RectTransform>().localScale = new Vector3(77f, 77f, 1f);
            ...
            circleSmall.GetComponent<RectTransform>().localScale = new Vector3(140f, 140f, 1f);
        ...
        else if (DeerUnity.CurrentActive == 2)
        {
            ...
            circleGhost.GetComponent<RectTransform>().localScale = new Vector3(140f, 140f, 1f);
        ...
        else if (DeerUnity.CurrentActive == 3)
        {
            ...
            circleBig.GetComponent<RectTransform>().localScale = new Vector3(140f, 140f, 1f);
